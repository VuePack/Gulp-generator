    ...
    $.fn.dialogModal = function (method) {
        ...
        var methods = {
            init: function (params) {
                ...
                dialogOverlay = $('<div class="dialog_overlay"></div>');
                    dialogMain = $('<div class="' + elemClass + '"></div>');
                    dialogContainer = $('<div class="' + elemClass + '_container"></div>').css(_options.css);
                    dialogCloseBut = $('<button type="button" class="close">&times;</button>');
                    dialogBody = $('<div class="' + elemClass + '_body"></div>');



                dialogMain.append(dialogOverlay);
                dialogMain.append(dialogContainer);
                //dialogContainer.append(dialogCloseBut, dialogBody);
                dialogContainer.append(dialogBody);
