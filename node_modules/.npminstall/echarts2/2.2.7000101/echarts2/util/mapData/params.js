...
define(function (require) {
    ...
    var mapParams = {
        ...
        'world': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/world_geo')));
        ...
        'china': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/china_geo')));
        ...
        '新疆': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/xin_jiang_geo')));
        ...
        '西藏': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/xi_zang_geo')));
        ...
        '内蒙古': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/nei_meng_gu_geo')));
        ...
        '青海': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/qing_hai_geo')));
        ...
        '四川': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/si_chuan_geo')));
        ...
        '黑龙江': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/hei_long_jiang_geo')));
        ...
        '甘肃': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/gan_su_geo')));
        ...
        '云南': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/yun_nan_geo')));
        ...
        '广西': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/guang_xi_geo')));
        ...
        '湖南': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/hu_nan_geo')));
        ...
        '陕西': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/shan_xi_1_geo')));
        ...
        '广东': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/guang_dong_geo')));
        ...
        '吉林': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/ji_lin_geo')));
        ...
        '河北': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/he_bei_geo')));
        ...
        '湖北': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/hu_bei_geo')));
        ...
        '贵州': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/gui_zhou_geo')));
        ...
        '山东': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/shan_dong_geo')));
        ...
        '江西': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/jiang_xi_geo')));
        ...
        '河南': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/he_nan_geo')));
        ...
        '辽宁': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/liao_ning_geo')));
        ...
        '山西': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/shan_xi_2_geo')));
        ...
        '安徽': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/an_hui_geo')));
        ...
        '福建': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/fu_jian_geo')));
        ...
        '浙江': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/zhe_jiang_geo')));
        ...
        '江苏': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/jiang_su_geo')));
        ...
        '重庆': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/chong_qing_geo')));
        ...
        '宁夏': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/ning_xia_geo')));
        ...
        '海南': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/hai_nan_geo')));
        ...
        '台湾': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/tai_wan_geo')));
        ...
        '北京': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/bei_jing_geo')));
        ...
        '天津': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/tian_jin_geo')));
        ...
        '上海': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/shang_hai_geo')));
        ...
        '香港': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/xiang_gang_geo')));
        ...
        '澳门': {
            getGeoJson: function (callback) {
                callback(decode(require('./geoJson/ao_men_geo')));
